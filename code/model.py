...
class Autoencoder3D(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv3 = nn.Conv3d(32, 32, kernel_size=5, pad=2)
        ...
        self.conv4 = nn.Conv3d(32, 1, kernel_size=1, pad=0)
        ...
        # Layer output image size: 1x6x7x6 ; Pad: 0
        self.deconv4 = nn.ConvTranspose3d(1, 1, kernel_size=1, pad=0)
        ...
        # N channels in: 1 ; N channels out: 32 ;  Stride: 1
        # Layer output image size: 32x12x14x12 ; Pad: 2
        self.deconv3 = nn.ConvTranspose3d(1, 32, kernel_size=5, pad=2)
        ...
        # N channels in: 32 ; N channels out: 32 ;  Stride: 1
        # Layer output image size: 32x24x28x24 ; Pad: 2
        self.deconv2 = nn.ConvTranspose3d(32, 32, kernel_size=5, pad=2)
        ...
        self.deconv1 = nn.ConvTranspose3d(32, 1, kernel_size=1, pad=0)
